<template>
	<view class="login-box">
		...
		<view class="no-padding" style="text-align: center;">
			<view class="uni-title">欢迎登录后台管理系统</view>
		</view>
		<view class="uni-container">
			<uni-forms ref="form" v-model="formData" :rules="rules" @submit="submit">
				<uni-forms-item name="username" labelWidth="50" label="账户">
					<input ref="usernameInput" @confirm="submitForm" class="uni-input-border" type="text"
						placeholder="账户" v-model="formData.username" />
				</uni-forms-item>
				<uni-forms-item name="password" labelWidth="50" label="密码">
				...
				<uni-forms-item v-if="needCaptcha" class="icon-container" name="captchaText" label="验证码"
					labelWidth="50">
			...
			<view class="uni-tips" v-if="isDevelopment">
